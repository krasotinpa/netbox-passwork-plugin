...
PassworkView.dispatch() → PassworkGateway (netbox_passwork/gateway.py)
   │  seven operations (login/confirm_totp/get_item/list_vaults/search_items/list_folder_contents/require_session);
